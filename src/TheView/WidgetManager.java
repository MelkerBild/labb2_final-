 ...
 * It communicates with the Control.Controller by calling methods of it when an action fires of in
...
public class WidgetManager extends JFrame implements Observer{
    ...
    // Constructor
    public WidgetManager(String framename){
